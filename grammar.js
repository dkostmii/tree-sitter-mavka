module.exports = grammar({
  ...
  rules: {
    ...
    as_statement: ($) => prec.left(1, seq($._expression, $._whitespace, token.immediate("як"), $.identifier, repeat(seq(',', $.identifier)))),
    ...
    inline_language_block: $ => seq(
      alias($.identifier, $.language_name),
      $.string_multiline
    ),
